...
## TODO to Issues GitHub Action

This repository contains a reusable GitHub Action that automatically creates GitHub issues from a `TODO.md` file when pushed to the main branch.
...
To use this action in your other repositories:
  ...
  create-issues:
    ...
    steps:
      ...
      - name: Process TODO file
        uses: project-zenith-systems/playground@main
        with:
...
See [TODO.md.example](TODO.md.example) for a complete example.
